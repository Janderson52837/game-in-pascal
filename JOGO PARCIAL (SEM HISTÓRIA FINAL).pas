Program Pzim ;
var
vida:integer; // Contagem das Vidas disponíveis para o usuario
life:integer; // Qtd. de HP disponível.
contvida :integer; // Variável para contagem das vidas gastas á cada Ginásio e Pergunta.
cont :integer;  // Contador para Uso ou não das Ajuda dos Pokémons.
